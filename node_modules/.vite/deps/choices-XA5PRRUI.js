            ...
            var Choices = function() {
              function Choices2(element, userConfig) {
                ...
                this.config = deepmerge_1.default.all(
                  [defaults_1.DEFAULT_CONFIG, Choices2.defaults.options, userConfig],
                  {
              ...
              Choices2.prototype.unhighlightItem = function(item) {
                if (!item || !item.id) {
                  return this;
                }
                var id = item.id, _a = item.groupId, groupId = _a === void 0 ? -1 : _a, _b = item.value, value = _b === void 0 ? "" : _b, _c = item.label, label = _c === void 0 ? "" : _c;
              ...
              Choices2.prototype.setValue = function(items) {
                var _this = this;
                if (!this.initialised) {
                  return this;
                }
              ...
              Choices2.prototype.setChoices = function(choicesArrayOrFetcher, value, label, replaceChoices) {
                var _this = this;
              ...
              Choices2.prototype.clearStore = function() {
              ...
              Choices2.prototype._render = function() {
              ...
              Choices2.prototype._createGroupsFragment = function(groups, choices, fragment) {
                var _this = this;
                if (fragment === void 0) {
              ...
              Choices2.prototype._createChoicesFragment = function(choices, fragment, withinGroup) {
                var _this = this;
                if (fragment === void 0) {
                  fragment = document.createDocumentFragment();
                }
              ...
              Choices2.prototype._createItemsFragment = function(items, fragment) {
                var _this = this;
                if (fragment === void 0) {
                  fragment = document.createDocumentFragment();
                }
              ...
              Choices2.prototype._selectPlaceholderChoice = function(placeholderChoice) {
                this._addItem({
              ...
              Choices2.prototype._handleButtonAction = function(activeItems, element) {
              ...
              Choices2.prototype._handleItemAction = function(activeItems, element, hasShiftKey) {
                var _this = this;
              ...
              Choices2.prototype._handleChoiceAction = function(activeItems, element) {
              ...
              Choices2.prototype._handleBackspace = function(activeItems) {
              ...
              Choices2.prototype._startLoading = function() {
                this._store.dispatch((0, misc_1.setIsLoading)(true));
              };
              Choices2.prototype._stopLoading = function() {
              ...
              Choices2.prototype._canAddItem = function(activeItems, value) {
                var canAddItem = true;
              ...
              Choices2.prototype._onKeyUp = function(_a) {
              ...
              Choices2.prototype._onEnterKey = function(event, activeItems, hasActiveDropdown) {
              ...
              Choices2.prototype._onEscapeKey = function(hasActiveDropdown) {
                if (hasActiveDropdown) {
                  this.hideDropdown(true);
                  this.containerOuter.focus();
                }
              ...
              Choices2.prototype._onDeleteKey = function(event, activeItems, hasFocusedInput) {
                var target = event.target;
              ...
              Choices2.prototype._addItem = function(_a) {
              ...
              Choices2.prototype._addChoice = function(_a) {
              ...
              Choices2.prototype._addGroup = function(_a) {
                var _this = this;
              ...
              Choices2.prototype._getTemplate = function(template) {
                var _a;
                var args = [];
              ...
              Choices2.prototype._addPredefinedGroups = function(groups) {
                var _this = this;
              ...
              Choices2.prototype._addPredefinedChoices = function(choices) {
                var _this = this;
                if (this.config.shouldSort) {
              ...
              Choices2.prototype._addPredefinedItems = function(items) {
                var _this = this;
              ...
              Choices2.prototype._setChoiceOrItem = function(item) {
                var _this = this;
              ...
              Choices2.prototype._findAndSelectChoiceByValue = function(value) {
                var _this = this;
                var choices = this._store.choices;
...
export default require_choices();
/*! choices.js v10.2.0 | © 2022 Josh Johnson | https://github.com/jshjohnson/Choices#readme */
//# sourceMappingURL=choices-XA5PRRUI.js.map
